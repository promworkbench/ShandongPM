...
//	protected String  clusterName;//聚类名
//	protected int clusterSize;//聚类大小
//	protected HashSet<String> trace;
//	//protected HashMap<cluster> cluster;
//	
//	protected List<Cluster> clusters;
//	
//	public Cluster(XLog log, String string) {
//		this.clusterName="cluster";
//		
//	}
//	public void addTrace(Integer integer) {
//		//clusters[i]
//	}
//	public Cluster getTrace() {
//		return null;
//	}
//	public int getSize() {
//		return this.clusterSize;
//	}
//	public void addCluster(XLog log, String string) {
//		// TODO 自动生成的方法存根
//		
//	}
//	public List<XTrace> getClusters() {
//		// TODO 自动生成的方法存根
//		return null;
//	}
//}
...
public class Cluster {
	...
	protected int clusterCenter;//添加聚类的中心
	protected double currentDistanceSum;
	public Cluster(XLog aLog, String aName) {
		name = aName;
		log = aLog;
		traceIndices = new ArrayList<Integer>();
	}
	public Cluster(XLog aLog, String aName,int clusterCenter1) {
		name = aName;
		log = aLog;
		clusterCenter=clusterCenter1;
	...
	public Cluster(XLog aLog, String aName, int[] aTraceIndices) {
		this(aLog, aName);
	...
	public Cluster(XLog aLog, String aName, Collection<Integer> aTraceIndices) {
		this(aLog, aName);
		traceIndices.addAll(aTraceIndices);
	}
	public void setLog(XLog alog)
	{
		log = alog;
	}
	...
	public void setClusterCenter(int str)
	{
		clusterCenter = str;
	}
	...
	public void setCurrentDistanceSum(double str)
	{
		currentDistanceSum = str;
	}

	public double getCurrentDistanceSum()
	{
